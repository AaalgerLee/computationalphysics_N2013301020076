...
#figure
n=input('the mass of Jupiter divided by its real mass is=')#change the mass of a planet right here
me,mj = ME,MJ*n
...
linej, = ax.plot([], [],lw=1,label='Jupiter') 
linee, = ax.plot([], [],lw=1,label='Earth') 
lines, = ax.plot([], [],lw=1,label='Sun')
...
#anim1.save('/home/shangguan/ex12/animationRESTframe/haha.png')
plt.show()  
